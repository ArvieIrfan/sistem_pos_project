...
<section class="section">
  <div class="row">
    <div class="col-lg-12">
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title text-center" style="font-size: 30px; padding: 40px;">Laporan Harian</h5>

          <form method="post">
            <div class="row g-3 align-items-center mt-3 mb-4">
              <div class="col-auto">
                <label for="tgl" class="form-label" style="font-size: 14px;">Pilih Tanggal</label>
